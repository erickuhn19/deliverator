...
|---|---|---|
| github.com/ethereum/go-ethereum | v1.17.3 | https://github.com/ethereum/go-ethereum (library packages — see note above) |
...
| Module | Version | Source |
|---|---|---|
| github.com/bits-and-blooms/bitset | v1.24.0 | https://github.com/bits-and-blooms/bitset/blob/v1.24.0/LICENSE |
| github.com/ethereum/go-ethereum/crypto/keccak | v1.17.3 | https://github.com/ethereum/go-ethereum/blob/v1.17.3/crypto/keccak/LICENSE |
| github.com/ethereum/go-ethereum/crypto/secp256k1 | v1.17.3 | https://github.com/ethereum/go-ethereum/blob/v1.17.3/crypto/secp256k1/LICENSE |
| github.com/holiman/uint256 | v1.3.2 | https://github.com/holiman/uint256/blob/v1.3.2/COPYING |
| github.com/spf13/pflag | v1.0.9 | https://github.com/spf13/pflag/blob/v1.0.9/LICENSE |
| golang.org/x/sync | v0.19.0 | https://cs.opensource.google/go/x/sync/+/v0.19.0:LICENSE |
