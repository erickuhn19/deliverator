...
type ClientAPI interface {
	...
	Fills(ctx context.Context, since *int64, limit int) ([]hl.Fill, ReadMeta, error)
	Funding(ctx context.Context, since *int64) ([]hl.UserFundingHistory, ReadMeta, error)
	...
	Ledger(ctx context.Context, since *int64) ([]hl.UserNonFundingLedgerUpdates, ReadMeta, error)
	...
	Orders(ctx context.Context, coin string) ([]hl.FrontendOpenOrder, ReadMeta, error)
	OrderStatus(ctx context.Context, oid *int64, cloid string) (*hl.OrderQueryResult, error)
	Pnl(ctx context.Context) ([]PnlWindow, error)
	PnlAttribution(ctx context.Context, since *int64, coin string) (*PnlAttributionView, ReadMeta, error)
	Portfolio(ctx context.Context) (*PortfolioView, error)
	Positions(ctx context.Context, coin string) ([]PositionView, ReadMeta, error)
